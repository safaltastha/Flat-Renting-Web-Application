    ...
    <div className="bg-[#EEE5FF] min-h-screen flex items-center justify-center p-4">
      <div className="container max-w-3xl mx-auto min-h-screen p-4"> {/* Adjusted max-w and added mx-auto */}
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-800">
            Our mission is to provide top-quality services and products that exceed our customers' expectations. 
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-800">
            Established in [Year], we have a rich history of growth and success. Our journey has been marked by 
