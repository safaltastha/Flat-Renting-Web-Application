        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            {roomCounts.numOfBedrooms > 0 &&
              renderLengthAndWidthFields(roomCounts.numOfBedrooms, "Bedroom")}
          </div>
          ...
          <div>
            ...
            {roomCounts.numOfLivingRooms > 0 &&
              renderLengthAndWidthFields(
                roomCounts.numOfLivingRooms,
                "Living Room"
              )}
          </div>
          ...
          <div>
            ...
            {roomCounts.numOfKitchens > 0 &&
              renderLengthAndWidthFields(roomCounts.numOfKitchens, "Kitchen")}
          </div>
