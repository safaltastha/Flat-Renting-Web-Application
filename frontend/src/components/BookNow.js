...
const BookNowWithVehicleForm = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#EEE5FF]">
      <form
        ...
        <div className="mt-2 flex space-x-4">
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="booking-yes" className="text-gray-600">Yes</label>
          </div>
          <div className="flex items-center">
            <input
              type="radio"
              ...
              className="mr-2"
            />
            <label htmlFor="booking-no" className="text-gray-600">No</label>
          </div>
        </div>

        {/* Conditional Vehicle Time Form */}
        {formData.booking === "yes" && (
          <VehicleTimeForm formData={formData} onChange={handleChange} />
        )}

        <div className="mt-5 text-center">
          <button
            type="submit"
            className="border-2 border-purple-600 bg-purple-600 text-white py-2 px-6 text-lg rounded-lg hover:bg-purple-700 transition duration-200"
          >
            Book
          </button>
        </div>
